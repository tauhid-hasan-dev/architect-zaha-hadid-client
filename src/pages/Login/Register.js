...
const Register = () => {
  const { createUser, updateUser, googleSignIn, logout } =
      ...
      <div className="hero-content flex-col  lg:flex-row">
        ...
        <div className="px-5 lg:px-20  py-10  flex flex-col items-center text-slate-300 ">
          <form
            ...
            className="p-7 lg:p-10  rounded-none border-slate-600 w-[350px]   lg:w-[450px] border "
          >
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-bordered text-slate-900 font-semibold rounded-none"
                required
              />
            </div>
            <div className="form-control">
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-bordered text-slate-900 font-semibold "
                required
              />
            </div>
            ...
            <div className="form-control mt-6">
              <button
                type="submit"
                className="border p-3 text-white  hover:bg-slate-600  "
              >
                Register
              </button>
            </div>
          ...
          <div className="mb-3 mt-3">Or login with with google</div>
          <div className="flex flex-row justify-center gap-3 mb-5 w-[100%]">
            <button
              onClick={handleGoogleSignIn}
              className="btn rounded-full  flex gap-2 "
            >
              {" "}
